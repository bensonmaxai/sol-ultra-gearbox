...
- 以目前 task 實際暴露的 spawn schema 判斷 native typed-child 能力；若沒有 \`agent_type\`，禁止建立會繼承 parent model 的 untyped child。只有 \`isolatedRunnerVerified=true\` 的 Luna／Terra read-only isolated route 可繼續，其他工作由 Sol root 完成。
