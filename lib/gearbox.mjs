...
- \`subagent-driven-development\`：Sol root 保留 plan 與 progress ledger；implementer／fixer 依序使用 \`terra_worker\`，task reviewer 使用 \`sol_reviewer\`，final adjudication 由 Sol root 負責；不平行啟動 writers。
...
const OWNED_PROBE_DIRECTORY =
  /^sol-ultra-gearbox-v2-(?:home-)?(?:luna_clerk|terra_explorer|terra_worker|sol_reviewer|terra_ultra_specialist|terra_max_worker)-[A-Za-z0-9]+$/;
