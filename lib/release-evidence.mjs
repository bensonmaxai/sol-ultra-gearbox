...
export function validateActiveInstallationSummary(value) {
  ...
  const checks = {
    ...
    hashes:
      ...
      value?.preInstallConfigSha256 !== value?.activeConfigSha256,
    root:
      exactRootFields &&
      root?.persisted === true &&
...
- Bound config transition: \`${shortCommit(activation.preInstallConfigSha256)}\` -> \`${shortCommit(activation.activeConfigSha256)}\`; policy \`${shortCommit(activation.policySha256)}\`
